/**
 * 🎓 SETTINGS TOUR - Tour para Pantalla de Más/Configuración
 */
...
const tourSteps: TourStep[] = [
  {
    id: 'welcome',
    target: '',
    title: '¡Bienvenido a Configuración! ⚙️',
    description: 'Personaliza Oti a tu gusto',
  ...
  },
  {
    ...
    title: 'Tu perfil 👤',
    description: 'Edita tu nombre y foto de perfil',
  ...
  },
  {
    ...
    description: 'Análisis y consejos personalizados',
    icon: <Brain className="w-5 h-5" />,
    placement: 'top',
  },
  {
    id: 'tax-declaration',
    target: 'tax-declaration',
    title: 'Declaración de Renta 📊',
    description: 'Gestión tributaria y educación fiscal',
  ...
  },
  {
    ...
    description: 'Cambia los colores y activa el modo oscuro',
  ...
  },
  {
    ...
    description: 'Importa transacciones desde extracto',
  ...
  },
  {
    ...
    title: 'Seguridad 🔒',
    description: 'Protege tu app con PIN o biométricos',
  ...
  },
  {
    ...
    description: 'Exporta o resetea tu información',
    icon: <Download className="w-5 h-5" />,
    placement: 'top',
  },
];

const TOUR_STORAGE_KEY = 'oti_settings_tour_completed';

export function SettingsTour({ onComplete }: SettingsTourProps) {
        ...
        >
          {highlightRect && !isCenterStep ? (
            ...
            <svg className="absolute inset-0 w-full h-full">
              <defs>
                <mask id="spotlight-mask-settings">
              ...
              <rect 
                ...
                height="100%" 
                fill="rgba(0, 0, 0, 0.7)"
                mask="url(#spotlight-mask-settings)"
              />
            </svg>
          ) : (
...
export function resetSettingsTour() {
  localStorage.removeItem(TOUR_STORAGE_KEY);
}

export function shouldShowSettingsTour(): boolean {
