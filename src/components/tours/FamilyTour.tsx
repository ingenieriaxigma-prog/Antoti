/**
 * 🎓 FAMILY TOUR - Tour para Pantalla de Grupos/Familia
 */
...
const tourSteps: TourStep[] = [
  {
    id: 'welcome',
    target: '',
    title: '¡Bienvenido a Grupos! 👥',
    description: 'Comparte finanzas con tu familia',
    icon: <Sparkles className="w-5 h-5" />,
    placement: 'center',
  },
  {
    id: 'create-first-group',
    target: 'create-first-group-button',
    title: 'Crear mi primer grupo 🎯',
    description: 'Crea un grupo para compartir transacciones con tu familia',
  ...
  },
  {
    ...
    description: 'Aquí verás todos tus grupos creados',
  ...
  },
  {
    ...
    description: 'Enviar invitación, ver tour y agregar más grupos',
    icon: <UserPlus className="w-5 h-5" />,
    placement: 'bottom',
  },
];

const TOUR_STORAGE_KEY = 'oti_family_tour_completed';

export function FamilyTour({ onComplete }: FamilyTourProps) {
          ...
          {highlightRect && !isCenterStep ? (
            ...
            <svg className="absolute inset-0 w-full h-full">
              ...
              <rect 
                ...
                height="100%" 
                fill="rgba(0, 0, 0, 0.7)"
                mask="url(#spotlight-mask-family)"
              />
            </svg>
          ) : (
...
export function resetFamilyTour() {
  localStorage.removeItem(TOUR_STORAGE_KEY);
}

export function shouldShowFamilyTour(): boolean {
