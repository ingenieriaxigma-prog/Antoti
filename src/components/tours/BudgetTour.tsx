/**
 * 🎓 BUDGET TOUR - Tour para Pantalla de Presupuestos
 */
...
const tourSteps: TourStep[] = [
  {
    ...
    description: 'Aprende a controlar tus gastos',
    icon: <Sparkles className="w-5 h-5" />,
    placement: 'center',
  },
  {
    id: 'month-selector',
    target: 'budget-month-selector',
    title: 'Selecciona el mes 📅',
    description: 'Cambia entre meses para ver o planificar presupuestos',
  ...
  },
  {
    ...
    title: 'Resumen total 💰',
    description: 'Ve cuánto has gastado vs. tu presupuesto total',
  ...
  },
  {
    ...
    description: 'Aquí verás todos tus presupuestos por categoría',
  ...
  },
  {
    ...
    description: 'Toca aquí para establecer límites por categoría',
    icon: <Plus className="w-5 h-5" />,
    placement: 'top',
  },
];

const TOUR_STORAGE_KEY = 'oti_budget_tour_completed';

export function BudgetTour({ onComplete }: BudgetTourProps) {
          ...
          {highlightRect && !isCenterStep ? (
            ...
            <svg className="absolute inset-0 w-full h-full">
              ...
              <rect 
                ...
                height="100%" 
                fill="rgba(0, 0, 0, 0.7)"
                mask="url(#spotlight-mask-budget)"
              />
            </svg>
          ) : (
...
export function resetBudgetTour() {
  localStorage.removeItem(TOUR_STORAGE_KEY);
}

export function shouldShowBudgetTour(): boolean {
